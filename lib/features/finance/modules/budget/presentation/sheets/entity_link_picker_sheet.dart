...
class EntityLinkPickerSheet {
      ...
      builder: (_) => Container(
        ...
        child: SafeArea(top: false, child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          ...types.map((t) => ListTile(
            ...
            onTap: () { Navigator.pop(context); _showEntityPicker(context, isDark, t.type, selectedId, onSelect); },
          )),
  ...
  static void _showEntityPicker(BuildContext context, bool isDark, String entityType, String? selectedId, ValueChanged<EntitySelection> onSelect) {
    final bg = isDark ? AppColors.cardDark : AppColors.card;
    final textPrimary = isDark ? AppColors.primaryForeground : AppColors.textPrimary;
    final divColor = isDark ? AppColors.border.withValues(alpha: 0.2) : AppColors.border.withValues(alpha: 0.4);
