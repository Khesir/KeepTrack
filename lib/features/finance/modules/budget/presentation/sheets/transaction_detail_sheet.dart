  ...
  Widget _buildViewBody(bool isDark, Color color, Color textPrimary, String? linked, bool isTransfer) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      if (t.imagePaths.isNotEmpty) ...[
        const SizedBox(height: 14),
        _DetailAttachmentList(imagePaths: t.imagePaths),
      ],
...
class _DetailAttachmentList extends StatelessWidget {
  final List<String> imagePaths;
  const _DetailAttachmentList({required this.imagePaths});
...
class _DetailAttachmentEditor extends StatefulWidget {
  final List<String> imagePaths;
  final String transactionId;
  final VoidCallback onChanged;

  const _DetailAttachmentEditor({required this.imagePaths, required this.transactionId, required this.onChanged});

  @override
  State<_DetailAttachmentEditor> createState() => _DetailAttachmentEditorState();
}

class _DetailAttachmentEditorState extends State<_DetailAttachmentEditor> {
